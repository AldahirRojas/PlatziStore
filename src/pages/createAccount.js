      ...
      <div className={styles['CreateAccount-container']}>
        ...
        <form action="/" className={styles.form}>
          <div>
            ...
            <input type="text" id="name" placeholder="Teff" className={styles['input-name']} />
            <label htmlFor="email" className={styles.label}>
              Email
            </label>
            <input type="text" id="email" placeholder="platzi@example.com" className={styles['input-email']} />
